...
/** @var \Akeeba\Component\DataCompliance\Administrator\View\Emailtemplates\HtmlView $this */
...
<div class="card mb-3">
	<h3 class="card-header bg-info text-white">
		<?= Text::_('COM_DATACOMPLIANCE_EMAILTEMPLATES_LBL_WHERE_HEAD') ?>
	</h3>
	<div class="card-body">
		<p>
			<?= Text::_('COM_DATACOMPLIANCE_EMAILTEMPLATES_LBL_WHERE_TEXT') ?>
		</p>
		<p>
			<a href="<?= Route::_('index.php?option=com_mails&filter[extension]=com_datacompliance') ?>"
...
<div class="card">
	<h3 class="card-header bg-primary text-white">
		<?= Text::_('COM_DATACOMPLIANCE_EMAILTEMPLATES_LBL_MANAGE_HEAD') ?>
	</h3>
	<div class="card-body">
