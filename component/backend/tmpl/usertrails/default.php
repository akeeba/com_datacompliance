...
?>
<form action="<?= Route::_('index.php?option=com_datacompliance&view=usertrails'); ?>"
			...
			<div id="j-main-container" class="j-main-container">
				...
				<table class="table" id="articleList">
					<caption class="visually-hidden">
						<?= Text::_('COM_DATACOMPLIANCE_USERTRAILS_TABLE_CAPTION'); ?>, <span
					...
					<tr>
						<th scope="col">
							<?= Text::_('COM_DATACOMPLIANCE_USERTRAIL_FIELD_USER_ID') ?>
						</th>
						<th scope="col">
							<?= Text::_('COM_DATACOMPLIANCE_USERTRAIL_FIELD_CREATED_BY') ?>
						</th>
						<th scope="col">
							<?= HTMLHelper::_('searchtools.sort', 'COM_DATACOMPLIANCE_USERTRAIL_FIELD_CREATED_ON', 'created_on', $listDirn, $listOrder); ?>
						</th>
						<th scope="col">
							<?= Text::_('COM_DATACOMPLIANCE_USERTRAIL_FIELD_REQUESTER_IP') ?>
						</th>
						<th scope="col">
							<?= Text::_('COM_DATACOMPLIANCE_USERTRAIL_FIELD_ITEMS') ?>
						</th>
					</tr>
					</thead>
					<tbody>
					...
					<tr class="row<?= $i++ % 2; ?>" data-draggable-group="0">
						...
						<td class="text-center">
							<button type="button"
								...
								<?= Text::_('COM_DATACOMPLIANCE_USERTRAIL_FIELD_ITEMS_BTN') ?>
							</button>
									...
									<div class="modal-content">
										...
										<div class="modal-body p-5 text-start">
											<table class="table table-striped table-sm w-100 align-topk">
												...
												<tr>
													<th scope="col">
														<?= Text::_('COM_DATACOMPLIANCE_USERTRAIL_HEAD_WHATCHANGED') ?>
													</th>
													<th scope="col">
														<?= Text::_('COM_DATACOMPLIANCE_USERTRAIL_HEAD_BEFORE') ?>
													</th>
													<th scope="col">
														<?= Text::_('COM_DATACOMPLIANCE_USERTRAIL_HEAD_AFTER') ?>
													</th>
												</tr>
												</thead>
												<tbody>
												<?php foreach ($item->items as $what => $info): ?>
