...
?>
<form action="<?= Route::_('index.php?option=com_datacompliance&view=exporttrails'); ?>"
			...
			<div id="j-main-container" class="j-main-container">
				...
				<table class="table" id="articleList">
					<caption class="visually-hidden">
						<?= Text::_('COM_DATACOMPLIANCE_EXPORTTRAILS_TABLE_CAPTION'); ?>, <span
					...
					<tr>
						<th scope="col">
							<?= Text::_('COM_DATACOMPLIANCE_EXPORTTRAIL_FIELD_USER_ID') ?>
						</th>
						<th scope="col">
							<?= Text::_('COM_DATACOMPLIANCE_EXPORTTRAIL_FIELD_CREATED_BY') ?>
						</th>
						<th scope="col">
							<?= HTMLHelper::_('searchtools.sort', 'COM_DATACOMPLIANCE_EXPORTTRAIL_FIELD_CREATED_ON', 'created_on', $listDirn, $listOrder); ?>
						</th>
						<th scope="col">
							<?= Text::_('COM_DATACOMPLIANCE_EXPORTTRAIL_FIELD_REQUESTER_IP') ?>
						</th>
					</tr>
					</thead>
					<tbody>
