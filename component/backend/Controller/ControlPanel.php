...
namespace Akeeba\Connection\Admin\Controller;

defined('_JEXEC') or die;

use Akeeba\Connection\Admin\Controller\Mixin\PredefinedTaskList;
...
class ControlPanel extends Controller
{
	...
	{
		/** @var \Akeeba\Connection\Admin\Model\ControlPanel $model */
		$model = $this->getModel();
