...
abstract class TemplateEmails
{
	...
	private const EMAIL_DEFINITIONS = [
		'com_datacompliance.example' => [
			'subject'       => 'COM_DATACOMPLIANCE_MAIL_EXAMPLE_SUBJECT',
			'bodyPlaintext' => 'COM_DATACOMPLIANCE_MAIL_EXAMPLE_BODY',
			'bodyHtml'      => 'COM_DATACOMPLIANCE_MAIL_EXAMPLE_BODY_HTML',
			'variables'     => [
			],
		],
	];
