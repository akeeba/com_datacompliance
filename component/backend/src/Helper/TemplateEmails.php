...
{
	/**
	 * Email templates known to this component.
	 */
	private const EMAIL_DEFINITIONS = [
		'com_datacompliance.user_warnlifecycle' => [
			'subject'       => 'COM_DATACOMPLIANCE_MAIL_USER_WARNLIFECYCLE_SUBJECT',
			'bodyPlaintext' => 'COM_DATACOMPLIANCE_MAIL_USER_WARNLIFECYCLE_BODY',
			'bodyHtml'      => 'COM_DATACOMPLIANCE_MAIL_USER_WARNLIFECYCLE_BODY_HTML',
			'variables'     => [
				'name',
				'email',
				'username',
		...
		'com_datacompliance.admin_lifecycle' => [
			'subject'       => 'COM_DATACOMPLIANCE_MAIL_ADMIN_LIFECYCLE_SUBJECT',
			'bodyPlaintext' => 'COM_DATACOMPLIANCE_MAIL_ADMIN_LIFECYCLE_BODY',
			'bodyHtml'      => 'COM_DATACOMPLIANCE_MAIL_ADMIN_LIFECYCLE_BODY_HTML',
			'variables'     => [
				'name',
				'email',
				'username',
		...
		'com_datacompliance.user_admin' => [
			'subject'       => 'COM_DATACOMPLIANCE_MAIL_USER_ADMIN_SUBJECT',
			'bodyPlaintext' => 'COM_DATACOMPLIANCE_MAIL_USER_ADMIN_BODY',
			'bodyHtml'      => 'COM_DATACOMPLIANCE_MAIL_USER_ADMIN_BODY_HTML',
			'variables'     => [
				'name',
				'email',
				'username',
		...
		'com_datacompliance.admin_user' => [
			'subject'       => 'COM_DATACOMPLIANCE_MAIL_ADMIN_USER_SUBJECT',
			'bodyPlaintext' => 'COM_DATACOMPLIANCE_MAIL_ADMIN_USER_BODY',
			'bodyHtml'      => 'COM_DATACOMPLIANCE_MAIL_ADMIN_USER_BODY_HTML',
			'variables'     => [
				'name',
				'email',
				'username',
		...
		'com_datacompliance.admin_admin' => [
			'subject'       => 'COM_DATACOMPLIANCE_MAIL_ADMIN_ADMIN_SUBJECT',
			'bodyPlaintext' => 'COM_DATACOMPLIANCE_MAIL_ADMIN_ADMIN_BODY',
			'bodyHtml'      => 'COM_DATACOMPLIANCE_MAIL_ADMIN_ADMIN_BODY_HTML',
			'variables'     => [
				'name',
				'email',
				'username',
		...
		'com_datacompliance.user_user' => [
			'subject'       => 'COM_DATACOMPLIANCE_MAIL_USER_USER_SUBJECT',
			'bodyPlaintext' => 'COM_DATACOMPLIANCE_MAIL_USER_USER_BODY',
			'bodyHtml'      => 'COM_DATACOMPLIANCE_MAIL_USER_USER_BODY_HTML',
			'variables'     => [
				'name',
				'email',
				'username',
		...
		'com_datacompliance.user_lifecycle' => [
			'subject'       => 'COM_DATACOMPLIANCE_MAIL_USER_LIFECYCLE_SUBJECT',
			'bodyPlaintext' => 'COM_DATACOMPLIANCE_MAIL_USER_LIFECYCLE_BODY',
			'bodyHtml'      => 'COM_DATACOMPLIANCE_MAIL_USER_LIFECYCLE_BODY_HTML',
			'variables'     => [
				'name',
				'email',
				'username',
