...
class Surfer
{
	 ...
	 * @since 4.1.0
	 */
	public string $uaString = 'Mozilla/5.0 (Data Compliance end-to-end test harness)';
	...
	public function __construct(string $baseUrl)
	{
		...
		$jar           = tempnam(sys_get_temp_dir(), 'dc-e2e-cookies-');
	 ...
	 *   - a GET link, `…&<token>=1`. Data Compliance itself must no longer put the token in a URL (see
	 *     {@see \Akeeba\DataCompliance\IntegrationTest\AbstractE2ETestCase::assertNoTokenInLinks()}),
	 *     but core pages still do.
	 *
