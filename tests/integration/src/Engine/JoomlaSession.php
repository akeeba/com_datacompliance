...
use Akeeba\DataCompliance\IntegrationTest\SiteProbe;
use RuntimeException;

/**
 * Establishes real Joomla sessions for a {@see Surfer}.
 *
 * Ported from the Akeeba Ticket System suite (itself from Admin Tools' Integration\Engine\Joomla).
 * Data Compliance is reached from both sides: the Options page (consent, export, wipe) is a
 * front-end page first, and the audit trails and lifecycle views live in the back-end.
 *
...
class JoomlaSession
{
	 ...
	 * would tie this to a template's markup and break between Joomla 5.4 and 6.1.
	 *
	 * @param   Surfer  $surfer  The surfer.
	 *
