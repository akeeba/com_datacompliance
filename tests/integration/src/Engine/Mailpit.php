 ...
 * none of it, and would have meant maintaining a fork of a core class across a 5.4 → 6.1 matrix.
 *
...
class Mailpit
{
	...
	/**
	 * Fetch the headers of one message.
	 *
	 * @param   string  $id  The Mailpit message ID.
	 *
	 * @return  array  Header name => list of values.
	 * @since   4.1.0
	 */
	public function headers(string $id): array
	{
		return $this->call('GET', '/api/v1/message/' . rawurlencode($id) . '/headers');
	}
	 ...
	 * component that routinely mails several people per post.
	 *
